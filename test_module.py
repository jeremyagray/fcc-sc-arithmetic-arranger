...
class UnitTests(unittest.TestCase):
    def test_arrangement(self):
        ...
        self.assertEqual(
            ...
            'with ["3 + 855", "3801 - 2", "45 + 43", "123 + 49"]')
        ...
        self.assertEqual(
            ...
            expected,
            'Expected different output when calling "arithmetic_arranger()" '
            'with ["11 + 4", "3801 - 2999", "1 + 2", "123 + 49", "1 - 9380"]')
    ...
    def test_too_many_problems(self):
        ...
        self.assertEqual(
            actual,
            expected,
            'Expected calling "arithmetic_arranger()" with more than five '
            'problems to return "Error: Too many problems."')
    ...
    def test_too_many_digits(self):
        ...
        self.assertEqual(
            actual,
            expected,
            'Expected calling "arithmetic_arranger()" with a problem that '
            'has a number over 4 digits long to return "Error: Numbers '
    ...
    def test_only_digits(self):
        ...
        self.assertEqual(
            ...
            expected,
            'Expected calling "arithmetic_arranger()" with a problem that '
            'contains a letter character in the number to return "Error: '
    ...
    def test_solutions(self):
        ...
        self.assertEqual(
            ...
            'calling "arithmetic_arranger()" with arithmetic problems and a '
