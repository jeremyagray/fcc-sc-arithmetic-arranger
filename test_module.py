...
test_cases = [
    ...
    pytest.param(
        ...
        (
            ...
            ' uses the "/" operator to return "Error: Operator'
            " must be '+' or '-'.\""
        ),
    ...
    pytest.param(
        ...
        (
            'Expected calling "arithmetic_arranger()" with a problem that'
            " has a number over 4 digits long to return"
            ' "Error: Numbers cannot be more than four digits."'
        ),
    ...
    pytest.param(
        ...
        (
            'Expected calling "arithmetic_arranger()" with a problem that'
            " contains a letter character in the number to return"
            ' "Error: Numbers must only contain digits."'
        ),
        id="test_only_digits",
    ),
    ...
    pytest.param(
        ...
        (
            "Expected solutions to be correctly displayed in output when"
            ' calling "arithmetic_arranger()" with five arithmetic problems'
            " and a second argument of `True`."
        ),
